...
Dois modelos, com pré-processamentos diferentes porque precisam de coisas
diferentes:

- **Regressão logística** — baseline linear. Precisa de imputação explícita,
...
MODELOS = {"logistica": logistica, "boosting": boosting}
